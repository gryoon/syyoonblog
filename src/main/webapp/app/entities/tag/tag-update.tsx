...
export const TagUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...tagEntity,
          entries: tagEntity?.entries?.map(e => e.id.toString()),
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label={translate('blogApp.tag.entry')} id="tag-entry" data-cy="entry" type="select" multiple name="entries">
                <option value="" key="0" />
                {posts
